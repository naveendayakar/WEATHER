...
print("+++++++++++++================+++++++++++++++")
Cursor.execute("SELECT * FROM public.weather_daily_table ORDER BY date,timezone")
print("Getting Results of  query --> SELECT * FROM public.weather_daily_table ORDER BY date,timezone")
print("+++++++++++++================+++++++++++++++")
try:
